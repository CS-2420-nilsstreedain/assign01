...
class MathVectorTester {
	...
	@Test
	public void addColAndRowVectors() {
		assertThrows(IllegalArgumentException.class, () -> {
			colVec.add(rowVec);
		});
		// NOTE: The code above is an example of a lambda expression. See Lab 1 for more
	...
	@Test
	public void vectorArrayLength() {
		assertThrows(IllegalArgumentException.class, () -> {
			@SuppressWarnings("unused")
			MathVector testMathVector = new MathVector(new double[0][0]);;
		});
		// NOTE: The code above is an example of a lambda expression. See Lab 1 for more
		// info.
	}
